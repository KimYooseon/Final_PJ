...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        actionInitialize->setObjectName("actionInitialize");
        actionMonthlyReservation = new QAction(MainWindow);
        actionMonthlyReservation->setObjectName("actionMonthlyReservation");
        ...
        patientStatusFrame->setObjectName("patientStatusFrame");
        ...
        medicalRecordFrame->setObjectName("medicalRecordFrame");
        ...
        enrollFrame->setObjectName("enrollFrame");
    ...
    {
        MainWindow->setWindowTitle(QCoreApplication::translate("MainWindow", "PaientManagement", nullptr));
